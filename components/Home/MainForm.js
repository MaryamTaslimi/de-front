...
export default function MainForm() {
    ...
    return (
        <div className = "w-full lg:max-w-lg -mt-4 md:mt-0 bg-shades-10 rounded-sm border-2 border-form-grey "
             id = {"form"}>
            <p className = {"bg-accent text-center text-shades-100 text-2xl font-light py-4 px-4 sm:px-8"}>دریافت
                مشاوره</p>
            <div className = {"px-4 sm:px-8"}>
                <p className = {"text-shades-80 text-justify text-base font-light my-6"}>
                    ما با طیف گسترده‌ای از بازیگران حوزه فناوری و نوآوری همکاری می‌کنیم.
                    <br/>
                    <br/>
                        ...
                        <div className = "bg-shades-20 flex flex-col gap-4 px-2 md:pr-8 py-6">
                            ...
                            <div className = "flex flex-row">
                                <input
                                    ...
                                    name = "op3"
                                    id = "op3"
                                    checked = {workArea === "شراکت استراتژیک و توسعه کسب و کار"}
                                    value = "شراکت استراتژیک و توسعه کسب و کار"
                                    onChange = {(e) =>
                                        setWorkArea(e.target.value)
                                    }
                                />
                                <label
                                    className = "mr-6 form-check-label inline-block text-shades-100 font-light text-base"
                                    htmlFor = "op3">
                                    شراکت استراتژیک و توسعه کسب و کار
