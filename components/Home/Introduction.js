    ...
    return (
        <div>
            ...
            <div className = {"flex flex-col lg:flex-row lg:w-3/5 gap-4 lg:gap-8"}>
                <p className = {"text-sm md:text-base font-light text-white grow-0 self-stretch text-justify"}>خانه خلاق
                ...
                <p className = {"text-base font-light text-white grow self-stretch text-justify"}>اکنون خانه خلاق و
                    نوآوری دنیای اقتصاد با
