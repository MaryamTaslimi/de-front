    ...
    return (
        <div>
            ...
            <div className = {"flex flex-col lg:flex-row lg:w-3/5 gap-4 lg:gap-8"}>
                <p className = {"text-sm md:text-base font-light text-white grow-0 self-stretch text-justify"}>
                    خانه خلاق
                    و نوآوری دنیای اقتصاد، با تکیه بر
                ...
                <p className = {"text-base font-light text-white grow self-stretch text-justify"}>
                    اکنون خانه خلاق و نوآوری دنیای اقتصاد با شعار «آینده از اینجا شروع می‌شود» قصد دارد تعاملی سازنده
                    میان اشخاص حقیقی و شرکت‌های مستعد سرمایه‌گذاری و دانش‌بنیان‌ها ایجاد کند و پلی میان نظام اقتصادی
                    سنتی و مدرن باشد.
                </p>
            </div>
            <Link href = "/about-us">
                <a className = {"flex flex-row justify-end items-center lg:w-3/5 mt-6 cursor-pointer"}>
