...
export default function MainTextMobile() {
    return (
            <div className = {"lg:hidden flex flex-col justify-between items-stretch gap-10"}>
                ...
                <div className = {"flex flex-col gap-4"}>
                    <p className = {"text-center font-light text-shades-10 text-2xl md:text-4xl border-b-2 border-shades-60 pb-2"}>چرا
                        مرکز نوآوری دنیای اقتصاد؟</p>
                    <p className = {"text-justify font-light text-shades-10 text-base md:text-2xl"}>
